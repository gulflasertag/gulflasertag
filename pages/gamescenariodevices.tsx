...
import GameScenarioDevicesPageIntro from "@/components/GameScenarioDevices/GameScenarioDevicesPageIntro";
import GameScenarioDevices from "@/components/GameScenarioDevices/GameScenarioDevices";

const GameScenarioDevicesPage: NextPage = () => {
  return (
    <>
      <Head>
        <title>
        ...
        <link
          rel="canonical"
          href="https://www.gulflasertag.net/gamescenariodevices"
        />
        <link
          rel="alternate"
          href="https://www.gulflasertag.net/gamescenariodevices"
        ...
        <link
          rel="alternate"
          href="https://www.gulflasertag.net/en/gamescenariodevices"
          hrefLang="en"
        />
        ...
        <meta
          property="og:url"
          content="https://www.gulflasertag.net/gamescenariodevices"
        />
...
export default GameScenarioDevicesPage;
