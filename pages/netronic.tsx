...
import NetronicsIntro from "@/components/Netronics/NetronicsIntro";
import NetronicSection from "@/components/Netronics/NetronicSection";

const NetronicPage: NextPage = () => {
  return (
    <>
      <Head>
        <title>
        ...
        <link rel="canonical" href="https://www.gulflasertag.net/netronic" />
        <link
          rel="alternate"
          href="https://www.gulflasertag.net/netronic"
          hrefLang="ar"
        />
        <link
          rel="alternate"
          href="https://www.gulflasertag.net/en/netronic"
          hrefLang="en"
        />
        ...
        <meta
          property="og:url"
          content="https://www.gulflasertag.net/netronic"
        />
