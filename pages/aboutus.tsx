...
import AboutTestinomials from "@/components/AboutUs/AboutTestinomials";
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://www.gulflasertag.net/aboutus" />
        <link
          rel="alternate"
          href="https://www.gulflasertag.net/aboutus"
          hrefLang="ar"
        />
        <link
          rel="alternate"
          href="https://www.gulflasertag.net/en/aboutus"
          hrefLang="en"
        />
        ...
        <meta
          property="og:url"
          content="https://www.gulflasertag.net/aboutus"
        />
