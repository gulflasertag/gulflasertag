                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-12">
                            <div class="mars_features_item">
                                ...
                                <p>الواقع الافتراضي يمكن أن يحول مساحة
                                    <br/>
                                    داخلية قدرها 80 متر مربع لتبدو بحجم
                                    <br/>
                                    ملعب كرة سلة.
                                </p>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-12">
                            ...
                            <h4 class="mars_h4">جهاز لوحي مزود بتطبيق  &nbsp;
                                <span class="mars_color">تشغيل الواقع الافتراضي</span>&nbsp; لإعداد مجموعات الألعاب والتحكم فيها
                            </h4>
                            <br/>
                            <br/>
                            <p class="mars_p">
                            ...
                            <p class="mars_p">يسمح لك بتغيير السيناريوهات ومواقع الألعاب بسرعة.
                            </p>
                            <br/>
                            <br/>
                            <br/>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-12">
                            ...
                            }>عمر بطارية يزيد عن 14 ساعة - أكثر من يوم
                                <br/>
                            ...
                            }>يلين الجزء  المطاطي ممتص الصدمات من
                                <br/>
                        ...
                        <div class="col-md-4 col-sm-4 col-12">
                            ...
                            }>يزن 800 جرام - لعبة مريحة حتى لأصغر
                                <br/>
                                اللاعبين!</p>
            ...
            <section class="rtl"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-12">
                            <h2 class="mars_section_title">سوار الصدمات
                                <br/>ســكــوربــيــون</h2>

                            <br/>
                            <p class="mars_p">
                                كل جرح من اللعبة يصاحبه صعقة كهربائية تؤدي إلى تقلص عضلي قصير المدى.
                            </p><br/>
                            <p class="mars_p">5 أوضاع للتشغيل والاهتزاز، و 4 مستويات من قوة الصدمة.
                            </p>
                            <br/>
                            <p class="mars_p">
