...
const DesigningOfArenasPage: NextPage = () => {
  return (
    <>
      <Head>
        <title>
        ...
        <link
          rel="canonical"
          href="https://www.gulflasertag.net/designingofarenas"
        />
        <link
          rel="alternate"
          href="https://www.gulflasertag.net/designingofarenas"
        ...
        <link
          rel="alternate"
          href="https://www.gulflasertag.net/en/designingofarenas"
          hrefLang="en"
        />
        ...
        <meta
          property="og:url"
          content="https://www.gulflasertag.net/designingofarenas"
        />
...
export default DesigningOfArenasPage;
