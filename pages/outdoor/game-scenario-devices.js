    ...
    return (
        <Layout>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="whiteTitleText">
                                        <p>حجم الشاشة الكبير يسمح لك بعرض صور متحركة مفصلة وعالية الجودة، بحيث يمكن تمييزها من مسافة بعيدة حتى مع ديناميكيات اللعبة سريعة التغير. السيناريوهات يتم عرضها بألوان نقية!
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="whiteTitleText">
                                        <p>جهاز يجعل ألعاب الليزر تاغ أكثر إثارة ويعطي ساحة اللعب الشخصية المميزة والتعريف.     شاشة LED بمقاس 27 سم تعرض الوضع المحدد للعبة الحالية بشكل صور متحركة.
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="taggerGroup rtl">
                <div class="accessoriesGroupHeader">
                    <div class="container">
                        <div class="taggerGroupHeaderPreTitle blackPreTitle">الملحقات
                        </div>
                    </div>
                </div>
                <div class="taggerGroupBody">
                                ...
                                <div class="taggerGroupItem">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <p>المساحة الداخلية منظمة بحيث يمكنك تغيير ترتيب الأقسام حسب احتياجاتك. الأقسام قابلة للإزالة ومثبتة باستخدام الفيلكرو.</p>
                                                </div>
                                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="whiteTitleText">
                                        ...
                                        <p>الأزرار التكتيكية الـ 18 تم تقسيمهم لمجموعات وفقًا للغرضهم، مما يتيح لك إرسال الأوامر على الفور. باستخدام مشبك سهل الاستخدام، يمكنك تثبيت جهاز التحكم عن بعد على حزامك.</p>
                                    </div>
                                </div>
