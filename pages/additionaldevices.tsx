...
import AdditionalDevicesPageIntro from "@/components/AdditionalDevices/AdditionalDevicesPageIntro";
import AdditionalDevices from "@/components/AdditionalDevices/AdditionalDevices";
import Footer from "@/components/Footer/Footer";

const AdditionalDevicesPage: NextPage = () => {
  return (
    <>
      <Head>
        <title>
        ...
        <link
          rel="canonical"
          href="https://www.gulflasertag.net/additionaldevices"
        />
        <link
          rel="alternate"
          href="https://www.gulflasertag.net/additionaldevices"
        ...
        <link
          rel="alternate"
          href="https://www.gulflasertag.net/en/additionaldevices"
          hrefLang="en"
        />
        ...
        <meta
          property="og:url"
          content="https://www.gulflasertag.net/additionaldevices"
        />
