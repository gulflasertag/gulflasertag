...
import CatalogsIntro from "@/components/Catalogs/CatalogsIntro";
import CatalogsDown from "@/components/Catalogs/CatalogsDown";
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://www.gulflasertag.net/catalogs" />
        <link
          rel="alternate"
          href="https://www.gulflasertag.net/catalogs"
          hrefLang="ar"
        />
        <link
          rel="alternate"
          href="https://www.gulflasertag.net/en/catalogs"
          hrefLang="en"
        />
        ...
        <meta
          property="og:url"
          content="https://www.gulflasertag.net/catalogs"
        />
